...
import { useMessageStatus } from "@/src/presentation/hooks/context/messageContext";
import { useNotificationStatus } from "@/src/presentation/hooks/context/notificationContext";
...
export default function TabLayout() {
  ...
  const { notificationCount } = useNotificationStatus();
  ...
  const handleTabPress = (e: any, target: string) => {
    ...
    router.push(`/(tabs)/${target}` as RelativePathString | ExternalPathString);
  };
