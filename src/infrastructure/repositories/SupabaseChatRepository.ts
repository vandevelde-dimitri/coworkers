...
export class SupabaseChatRepository implements ChatRepository {
  private static instance: SupabaseChatRepository;

  private constructor() {}

  static getInstance(): SupabaseChatRepository {
    if (!SupabaseChatRepository.instance) {
      SupabaseChatRepository.instance = new SupabaseChatRepository();
    }
    return SupabaseChatRepository.instance;
  }
  ...
  async sendMessage(conversationId: string, content: string): Promise<void> {
    ...
    if (userError || !authUser) throw new UnauthorizedError();
