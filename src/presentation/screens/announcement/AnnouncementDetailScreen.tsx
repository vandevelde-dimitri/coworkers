            ...
            <View style={styles.ownerInfo}>
              ...
              <View style={styles.badgeRow}>
                <View style={styles.badge}>
                  <Text style={styles.badgeText}>{item.owner.fcName}</Text>
                </View>
        ...
        {item.passenger.length > 0 ? (
          item.passenger.map((p) => (
            <View key={p.id} style={styles.passengerRow}>
              ...
              {isOwner && (
                <RemoveParticipantButton participant={p} annonce={item} />
              )}
            </View>
          ))
        ) : (
          <Text style={styles.emptyText}>Aucun passager pour le moment</Text>
        )}
